...
func NewGetFrontendSliderParams() GetFrontendSliderParams {
	...
	return GetFrontendSliderParams{}
}

// GetFrontendSliderParams contains all the bound params for the get frontend slider operation
...
func (o *GetFrontendSliderParams) bindProvider(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
