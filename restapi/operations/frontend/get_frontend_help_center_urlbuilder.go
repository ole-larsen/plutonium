...
func (o *GetFrontendHelpCenterURL) Build() (*url.URL, error) {
	...
	var _path = "/frontend/help-center"
...
func (o *GetFrontendHelpCenterURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetFrontendHelpCenterURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetFrontendHelpCenterURL")
	}
