...
func (o *GetFrontendCreateAndSellURL) Build() (*url.URL, error) {
	...
	var _path = "/frontend/create-and-sell"
...
func (o *GetFrontendCreateAndSellURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetFrontendCreateAndSellURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetFrontendCreateAndSellURL")
	}
