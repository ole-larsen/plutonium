...
func NewPostFrontendContactFormParams() PostFrontendContactFormParams {
	...
	return PostFrontendContactFormParams{}
}

// PostFrontendContactFormParams contains all the bound params for the post frontend contact form operation
...
func (o *PostFrontendContactFormParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.PublicContactForm
