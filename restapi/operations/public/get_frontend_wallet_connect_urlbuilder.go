...
func (o *GetFrontendWalletConnectURL) Build() (*url.URL, error) {
	...
	var _path = "/frontend/wallet-connect"
...
func (o *GetFrontendWalletConnectURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetFrontendWalletConnectURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetFrontendWalletConnectURL")
	}
