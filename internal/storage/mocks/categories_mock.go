...
func (m *MockCategoriesRepositoryInterface) MigrateContext(ctx context.Context) error {
	m.ctrl.T.Helper()
...
func (mr *MockCategoriesRepositoryInterfaceMockRecorder) MigrateContext(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MigrateContext", reflect.TypeOf((*MockCategoriesRepositoryInterface)(nil).MigrateContext), ctx)
}
