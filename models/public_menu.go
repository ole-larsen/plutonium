...
func (m *PublicMenu) validateAttributes(formats strfmt.Registry) error {
...
func (m *PublicMenu) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
