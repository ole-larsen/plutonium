...
func (m *MarketplaceCollectible) validateAttributes(formats strfmt.Registry) error {
...
func (m *MarketplaceCollectible) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MarketplaceCollectible) UnmarshalBinary(b []byte) error {
	var res MarketplaceCollectible
